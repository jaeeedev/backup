...
const pcCurLibs = document.querySelectorAll(".changeCurLib ul li")

const lnb = document.querySelector(".menus");

lnb.addEventListener("mouseenter", () => {
    lnb.style.height = "380px";
})
lnb.addEventListener("mouseleave", () => {
    lnb.style.height = "30px";
})
...
<div>
    ...
    <p><span>월~일</span>08:00 ~ 22:00</p>
        ...
        loca2: 128.579755,
        imgSource: "../img/cyd.png"
    }, {
        name: "고향의봄", offday: `<div>
<h3>참고ㆍ연속간행물실<br>
디지털자료실<br>
유아ㆍ어린이자료실</h3>
<p><span>화~일</span>09:00 ~ 18:00</p>
...
<p><span>월~일</span>08:00 ~ 22:00</p>
    ...
    </div>`, loca1: 35.253333, loca2: 128.648453, imgSource: "../img/myeonggok.png"
    }, {
        name: "마산합포", offday: `<div>
...
<div>
    <h3>자율학습실</h3>
    <p><span>월~일</span>08:00 ~ 22:00</p>
</div>`, loca1: 35.183122, loca2: 128.562774, imgSource: "../img/happo.png"
    }, {
        name: "마산회원", offday: `<div>
<h3>어린이자료실</h3>
<p><span>화~일</span>09:00 ~ 18:00</p>
</div>
<div>
...
<h3>자율학습실</h3>
<p><span>월~일</span>08:00 ~ 22:00</p>
</div>`, loca1: 35.224629, loca2: 128.573516, imgSource: "../img/hoiwon.png"
    }, {
        name: "내서", offday: `<div>
...
<h3>자율학습실</h3>
<p><span>월~일</span>09:00 ~ 22:00</p>
</div>`, loca1: 35.232838, loca2: 128.501330, imgSource: "../img/naeseo.png"
    }, {
        name: "중리초등", offday: `<div>
<h3>어린이자료실</h3>
...
`, loca1: 35.255483, loca2: 128.519933, imgSource: "../img/jungli.png"
    }, {
        name: "진해", offday: `<div>
<h3>어린이자료실</h3>
<p><span>화~금</span>09:00 ~ 22:00</p>
...
<p><span>공휴일</span>08:00 ~ 22:00</p>
</div>`, loca1: 35.152537, loca2: 128.667531, imgSource: "../img/jinhae.png"
    }, {
        name: "동부", offday: `<div>
        <h3>어린이자료실<br>디지털‧연속간행물실</h3>
        <p><span>월~목</span>09:00 ~ 22:00</p>
        ...
        <h3>자율학습실</h3>
        <p><span>월~일</span>08:00 ~ 22:00</p>
        </div>` , loca1: 35.100027, loca2: 128.817140,
        imgSource: "../img/east.png"
    }
];

selectLibrary.forEach((div) => div.addEventListener("click", () => {
...
function changeLocation(index) {
    const changeGeo = new kakao.maps.LatLng(libArr[index].loca1, libArr[index].loca2);
