...
const menuList = document.querySelectorAll(".depth_1 li");

menuList.forEach((li) => {
  li.addEventListener("mouseover", () => {
    menus.style.height = "390px";
  });

  li.addEventListener("mouseout", () => {
    menus.style.height = "26px";
  });
});
...
window.addEventListener(
  ...
  optimize(() => {
    ...
    if (window.pageYOffset >= 150) {
      document.querySelector(".offday h2").style.transform = "translateY(0)";
      document.querySelector(".offday h2").style.opacity = 1;
    }
  }),
  { passive: true }
);
...
window.addEventListener("load", () => {
  ...
  document.querySelector(".pcLibInfo a").style.transform = "translateY(0)";
  document.querySelector(".pcLibInfo a").style.opacity = 1;
});
